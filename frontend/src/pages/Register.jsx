...
import { User, Mail, Lock, ShieldAlert, Phone } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="glass-panel-glow max-w-[450px] w-full mx-auto my-16 p-8 md:p-10 text-center">
      <h2 className="font-display text-3xl font-extrabold text-white mb-2">
        Create Account
      </h2>
      <p className="text-slate-400 text-sm mb-8">
        Get started with <span className="gradient-text font-display font-bold bg-gradient-to-r from-accent to-secondary-neon bg-clip-text text-transparent">BidX</span>
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-5 flex flex-col gap-2">
          <label className="text-sm font-semibold text-slate-400 text-left">Username</label>
        ...
        <div className="mb-5 flex flex-col gap-2">
          <label className="text-sm font-semibold text-slate-400 text-left">Mobile Number</label>
          <div className="relative">
        ...
        >
          {loadingSubmit ? 'Registering...' : 'Sign Up'}
        </button>
      </form>
